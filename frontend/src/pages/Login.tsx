    ...
    <div className="flex h-full items-center justify-center bg-zinc-50">
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={submit} className="rounded-xl border border-zinc-200 bg-white p-6 shadow-sm">
          <label className="mb-1.5 block text-xs font-medium text-zinc-500">OA 账号</label>
          <input
            value={username}
            ...
            className="mb-3 w-full rounded-lg border border-zinc-300 px-3 py-2 text-sm outline-none transition focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20"
          />
          <label className="mb-1.5 block text-xs font-medium text-zinc-500">密码</label>
          ...
          <p className="mb-4 text-[11px] text-zinc-400">使用您本人的 OA 账号登录</p>
